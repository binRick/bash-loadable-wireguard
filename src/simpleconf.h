...
typedef SimpleConfSpecialHandlerResult (*SimpleConfSpecialHandler)(void **output_p, const char *arg, void *user_data);
...
int sc_build_command_line_from_file(const char *file_name, const SimpleConfConfig *config, const SimpleConfEntry entries[], size_t entries_count, char *app_name, int *argc_p, char ***argv_p);
