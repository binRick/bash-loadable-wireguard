...
void totpuri_init(struct totpuri *uri, const char *label, const char *issuer, const char *secret);
...
int32_t compute_totp(const char *secret, size_t secretlen, time_t timestamp, size_t timestep, size_t digits);
